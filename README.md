# API TODO - CI/CD
[![CI/CD Pipeline](https://github.com/zid04/api-todoci/actions/workflows/ci-cd.yml/badge.svg)](https://github.com/zid04/apitodo-ci/actions/workflows/ci-cd.yml)
...
## API Déployée
**URL :** https://api-todo-ci-veronique.onrender.com
## Endpoints
...
```bash
curl https://api-todo-ci-veronique.onrender.com/todos
```

### Créer un todo
```bash
curl -X POST https://api-todo-ci-veronique.onrender.com/todos \
