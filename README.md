...
[![Deploy Multi-Env](https://github.com/zid04/api-todoci/actions/workflows/deploy-multi-env.yml/badge.svg)](https://github.com/zid04/api-todo-ci/actions/workflows/deploy-multi-env.yml)
![Version](https://img.shields.io/github/v/tag/zid04/api-todoci?label=version)
...
|---------------|-----|---------|--------|
| **Production** | [api-todo-ci-veronique-prod.onrender.com](https://api-todo-ci-veronique-prod.onrender.com) | `main` | Actif |
| **Staging** | [api-todo-veronique-staging.onrender.com](https://api-todo-veronique-staging.onrender.com) | `develop` | Actif |
---
...
|---------|-------|-------------|---------|
| GET | `/` | Infos de l'API | `curl https://api-todo-ci-veronique-prod.onrender.com/` |
| GET | `/todos` | Liste tous les todos | `curl https://api-todo-ci-veronique-prod.onrender.com/todos` |
| GET | `/todos/:id` | Un todo spécifique | `curl https://api-todo-ci-veronique-prod.onrender.com/todos/1` |
...
| GET | `/health` | Health check | `curl https://api-todo-ci-veronique-prod.onrender.com/health` |
---
## Tests
```bash
...
git clone https://github.com/zid04/api-todo-ci.git
cd api-todo-ci
# Installer les dépendances
npm install
...
- Render.com
### Auteur
**veronique zida fanta owona** - [GitHub](https://github.com/zid04)
---
## Ressources
